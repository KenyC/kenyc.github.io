...
/* package kenyc-0.1.0.0 */
#ifndef VERSION_kenyc
#define VERSION_kenyc "0.1.0.0"
#endif /* VERSION_kenyc */
#ifndef MIN_VERSION_kenyc
#define MIN_VERSION_kenyc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_kenyc */
...
#define CURRENT_COMPONENT_ID "kenyc-0.1.0.0-JoCYjQVpevtExpXp7Zyhvu-kenyc"
